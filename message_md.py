...
class Config:
    def __init__(self, fileName=""):
        ...
        self.STR_COULD_NOT_MOVE_MESSAGES_FILE = 23
    ...
    def loadPeople(self):
        ...
        try:
            ...
            for line in peopleFile:
                ...
                try:
                    person = Person()
                    person.phoneNumber = x[self.PERSON_FIELD_NUMBER]
                    person.slug = x[self.PERSON_FIELD_SLUG]
                    person.firstName = x[self.PERSON_FIELD_FIRST_NAME]
